 ...
 * @author miguelangel
 */
@WebServlet(name = "ImpuestoEliminar", urlPatterns = {"/impuesto/eliminar"})
public class ImpuestoEliminar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean eliminado = impuestoDAO.eliminar(id_impuesto);

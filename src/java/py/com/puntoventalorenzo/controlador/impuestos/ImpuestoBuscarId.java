 ...
 * @author miguelangel
 */
@WebServlet(name = "ImpuestoBuscarId", urlPatterns = {"/impuesto/buscar/id"})
public class ImpuestoBuscarId extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Impuesto impuesto = impuestoDAO.buscarId(id_impuesto);
            
            out.print(impuesto.getJSONObject());
            out.flush();
        }
    }

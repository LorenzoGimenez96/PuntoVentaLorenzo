 ...
 * @author miguelangel
 */
@WebServlet(name = "ImpuestoAgregar", urlPatterns = {"/impuesto/agregar"})
public class ImpuestoAgregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean agregado = impuestoDAO.agregar(impuesto);

 ...
 * @author miguelangel
 */
@WebServlet(name = "ItemAgregar", urlPatterns = {"/item/agregar"})
public class ItemAgregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int precio_item = Integer.parseInt(request.getParameter("precio_item"));
            ...
            */
            ...
            item.setPrecio_item(precio_item);
            ...
            boolean agregado = itemDAO.agregar(item);

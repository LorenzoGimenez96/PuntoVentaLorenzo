 ...
 * @author miguelangel
 */
@WebServlet(name = "ItemBuscarId", urlPatterns = {"/item/buscar/id"})
public class ItemBuscarId extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Item item = itemDAO.buscarId(id_item);
            
            out.print(item.getJSONObject());
            out.flush();
        }
    }
